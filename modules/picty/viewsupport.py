...
TOKENS=[
(' ',(_or,bool,bool),'Spaces between terms is an OR operator'),
('&',(_and,bool,bool),'Use the ampersand as an AND operator'),
('|',(_or,bool,bool),'The pipe is an OR operator evaluated before &'),
('!',(_not,None,bool),'The NOT operator'),
('tag=',(contains_tag,None,str),'Tag equal to (exact match)'),
('title=',(StringEquals('Title'),None,str),'Title equal to (exact match)'),
('descr=',(StringEquals('ImageDescription'),None,str),'Description equal to (exact match)'),
('artist=',(StringEquals('Artist'),None,str),'The Artist field'),
('copyright=',(StringEquals('Copyright'),None,str),'The Copyright field'),
('album=',(StringEquals('Album'),None,str),'The Album field'),
('folder=',(FolderEquals(),None,str),'Images in this folder (relative to collection root)'),
('folder~',(FolderEquals(True),None,str),'Images in this folder or its subfolders'),
('title~',(StringEquals('Title',True,False),None,str),'The Title field (partial match)'),
('descr~',(StringEquals('ImageDescription',True,False),None,str),'Image Description (partial match)'),
('artist~',(StringEquals('Artist',True,False),None,str),'The Artist field (partial match)'),
('copyright~',(StringEquals('Copyright',True,False),None,str),'The Copyright field (partial match)'),
('album~',(StringEquals('Album',True,False),None,str),'The Album field (partial match)'),
('shutter=',(RationalCompare('ExposureTime'),None,str),'Shutter speed (ms)'),
('shutter>=',(RationalCompare('ExposureTime',float.__ge__),None,str),'Slower shutter speed (ms)'),
('shutter<=',(RationalCompare('ExposureTime',float.__le__),None,str),'Faster shutter speed (ms)'),
('shutter>',(RationalCompare('ExposureTime',float.__gt__),None,str),'Strictly slower Shutter speed (ms)'),
('shutter<',(RationalCompare('ExposureTime',float.__lt__),None,str),'Stictly faster Shutter speed (ms)'),
('aperture=',(RationalCompare('FNumber'),None,str),'Aperture (F-Stops)'),
('aperture>=',(RationalCompare('FNumber',float.__ge__),None,str),'Higher F-Stop'),
('aperture<=',(RationalCompare('FNumber',float.__le__),None,str),'Lower F-Stops)'),
('aperture>',(RationalCompare('FNumber',float.__gt__),None,str),'Strictly Higher F-Stops'),
('aperture<',(RationalCompare('FNumber',float.__lt__),None,str),'Stictly Lower F-Stops'),
('focal=',(RationalCompare('FocalLength'),None,str),'Focal length (mm)'),
('focal>=',(RationalCompare('FocalLength',float.__ge__),None,str),'Longer focal length (mm)'),
('focal<=',(RationalCompare('FocalLength',float.__le__),None,str),'Shorter focal length (mm)'),
('focal>',(RationalCompare('FocalLength',float.__gt__),None,str),'Strictly longer focal length (mm)'),
('focal<',(RationalCompare('FocalLength',float.__lt__),None,str),'Strictly shorter focal length (mm)'),
('iso=',(IntCompare('IsoSpeed'),None,str),'ISO speed rating'),
('iso>=',(IntCompare('IsoSpeed',ge),None,str),'Higher ISO speed rating'),
('iso<=',(IntCompare('IsoSpeed',le),None,str),'Lower ISO speed rating'),
('iso>',(IntCompare('IsoSpeed',gt),None,str),'Strictly higher ISO speed rating'),
('iso<',(IntCompare('IsoSpeed',lt),None,str),'Strictly lower IS speed rating'),
('mdate=',(DateCompare('DateMod',eq,True),None,DateTime),'Modification date (file timestamp)'),
('mdate>=',(DateCompare('DateMod',ge,True),None,DateTime),'Newer than modification date (file timestamp)'),
('mdate<=',(DateCompare('DateMod',le,True),None,DateTime),'Older than modification date (file timestamp)'),
('mdate>',(DateCompare('DateMod',gt,True),None,DateTime),'Modification date (file timestamp)'),
('mdate<',(DateCompare('DateMod',lt,True),None,DateTime),'Modification date (file timestamp)'),
('date=',(DateCompare('DateTaken'),None,DateTime),'Exif date taken'),
('date>=',(DateCompare('DateTaken',ge),None,DateTime),'Exif date taken is newer than'),
('date<=',(DateCompare('DateTaken',le),None,DateTime),'Exif date taken is older than'),
('date>',(DateCompare('DateTaken',gt),None,DateTime),'Exif date taken is strictly newer than'),
('date<',(DateCompare('DateTaken',lt),None,DateTime),'Exif date taken is strictly older than'),
('selected',(selected_filter,None,None),'Include all selected images'),
('changed',(changed_filter,None,None),'Include only images with unsaved changes'),
('geotagged',(geotagged_filter,None,None),'Include images with GPS tags'),
('tagged',(tagged_filter,None,None),'Include images with keyword tags'),
('thumb',(thumb_filter,None,None),'Include images with thumbnails'),
]
